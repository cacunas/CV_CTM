...
void Datapool::clear() {
    ...
    if(reliabilityMap != NULL)
      delete reliabilityMap;
    if(empiricalReliabilityMap != NULL)
      delete empiricalReliabilityMap;
    if(temporalVariance != NULL)
      delete temporalVariance;
