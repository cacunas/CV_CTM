...
#include "DRAW/setReliabilityMap.h"
#include "DRAW/setEmpiricalReliabilityMap.h"
...
ADD_DRAW(setReliabilityMap)
ADD_DRAW(setEmpiricalReliabilityMap)
//TEMP
...
void paintView::setDraw(){
    ...
    REGISTER_DRAW_PAINT(setReliabilityMap);
    REGISTER_DRAW_PAINT(setEmpiricalReliabilityMap);
//TEMP
