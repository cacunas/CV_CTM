...
#include "MODULES/TemporalVarianceBGModule.h"
#include "MODULES/PlayFieldDetectionModule.h"
...
ADD_MODULE(TemporalVarianceBGModule)
ADD_MODULE(PlayFieldDetectionModule)
...
void VideoAnalysis::setAvailableModules() {
    ...
    REGISTER_MODULE(TemporalVarianceBGModule, SEGMENTATION);
    ...
    REGISTER_MODULE(HMTrackingModule, SEGMENTATION);
